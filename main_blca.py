...
# Pathing Parameters
parser.add_argument('--data_root_dir', type=str, default='/data/alven/wenhuasdrive/MNHS-SPHPM-CARE/GLOBALENVIRONHealth/CMIP6/Generated_by_zk/TCGA/Bladder', help='data directory')
parser.add_argument('--split_dir', type=str, default='tcga_blca', help='Which cancer for training.')
...
if __name__ == "__main__":
    ...
    sys.stdout = Logger('./log/' + str(files) + '_'  + '.txt')

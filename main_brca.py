...
# Pathing Parameters
parser.add_argument('--data_root_dir',   type=str, default='/data/alven/wenhuasdrive/MNHS-SPHPM-CARE/GLOBALENVIRONHealth/CMIP6/Generated_by_zk/TCGA/Breast', help='Data directory to WSI features (extracted via CLAM')
parser.add_argument('--split_dir',       type=str, default='tcga_brca', help='Which cancer type within ')

parser.add_argument('--affinity_threshold', type=float, default=0.90)
